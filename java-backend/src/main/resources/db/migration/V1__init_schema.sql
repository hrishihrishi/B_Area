...
CREATE TABLE products (
    ...
    category VARCHAR(100) NOT NULL,  -- this should be dynamic, if a new unknown category is used it has to be saved in dropdown for future, public use.
